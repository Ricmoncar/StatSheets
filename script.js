...
const TRAITS = {
  ...
  ironvow:      { name:'Iron Vow', rarity:'legendary', desc:'Sacrifice one main stat permanently (set to 1). All other main stats gain +40%.', passive:[], situational:[
  ...
  infinite:      { name:'Infinite', rarity:'mythic', desc:'All cultivation traits grow 2x faster. No stack limit on any cultivation trait.', passive:[], notes:'Doubles all cultivation gains. Removes max stack caps from all cultivation traits on this character.' },
