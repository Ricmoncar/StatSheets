...
const TRAITS = {
  ...
  hx_magic: { name: 'Magical Girlypops', rarity: 'hexxed', desc: 'Whole party transforms into magical girls!: +20% all stats, x2 MAG.', passive: [{ stat: 'all_main', op: 'pct', value: 20 }, { stat: 'mag', op: 'mul', value: 2 }] },
