...
const TRAITS = {
  ...
  damnation: { name: 'Damnation', rarity: 'legendary', desc: 'Every enemy killed drops a Soul. Collect souls for permanent +3 ATK and +3 DEF each. No cap.', passive: [], notes: 'Permanent soul-stack +3 ATK and +3 DEF per kill.' },
  kindredmark: { name: 'Mark of the Kindred', rarity: 'legendary', desc: 'Designate a Hunt target. Each hunted enemy defeated permanently grants +15 to all stats. Marks renew each combat.', passive: [], notes: 'Hunt target system. +15 all stats per marked kill. Permanent.' },
  crimsonpact: { name: 'Crimson Pact', rarity: 'legendary', desc: 'Every 30 HP = +1 MAG. Every 10 MAG = +15 HP. Both stats scale off each other dynamically.', passive: [], notes: 'HP/MAG dynamic conversion. Stats update whenever either is gained.' },
  ...
  // ============ LOL-INSPIRED: MYTHIC ============
  lastingspoils: { name: 'Lasting Spoils', rarity: 'mythic', desc: 'Every enemy defeated drops an essence. Permanently gain +6 ATK and +6 DEF per soul collected. No cap.', passive: [], notes: 'Permanent soul-stacking: +6 ATK and +6 DEF per kill.' },
  ...
  feast: { name: 'Feast', rarity: 'mythic', desc: 'On kill: permanently grow. Gain +20 HP, +5 ATK, +3 DEF, +3 MAG. No cap. You are what you eat.', passive: [], notes: 'Permanent stat growth per kill. No max stacks.' },
  ...
  holymantle:    { name: 'Holy Mantle', rarity: 'rare', desc: 'Once per battle, the first hit that would damage you is completely nullified. Automatic — no action required.', passive: [], situational: [{ id: 'hm-active', label: 'Holy Mantle active (shield up)', passive: [] }, { id: 'hm-broken', label: 'Holy Mantle consumed (shield gone)', passive: [] }] },
...
const SHIMMYFUL_MYTHIC_TRAITS = {
  ...
  lastingspoils: { name: 'SHIMMYFUL Lasting Spoils', desc: 'Every enemy defeated permanently grants +10 ATK and +10 DEF per soul. No cap.', passive: [], notes: 'Permanent soul-stacking: +10 ATK and +10 DEF per kill.' },
  ...
  feast: { name: 'SHIMMYFUL Feast', desc: 'On kill: permanently gain +30 HP, +8 ATK, +5 DEF, and +5 MAG. Every 3rd kill, all future growth bonuses double permanently.', passive: [], notes: 'Permanent scaling per kill. Every 3rd kill: growth doubles.' },
...
const SHIMMYFUL_LEGENDARY_TRAITS = {
  ...
  damnation: { name: 'SHIMMYFUL Damnation', desc: 'Every enemy killed drops a Soul. Gain +5 ATK and +5 DEF per soul. No cap.', passive: [], notes: 'Permanent soul-stack: +5 ATK and +5 DEF per kill.' },
  kindredmark: { name: 'SHIMMYFUL Mark of the Kindred', desc: 'Each hunted enemy defeated permanently grants +25 to all stats. Marks renew each combat.', passive: [], notes: '+25 all stats per marked kill. Permanent.' },
  crimsonpact: { name: 'SHIMMYFUL Crimson Pact', desc: 'Every 20 HP = +1 MAG. Every 8 MAG = +15 HP. Both stats scale off each other more aggressively.', passive: [], notes: 'Tighter HP/MAG conversion loop. Stats update whenever either is gained.' },
